...
**🚨 0 / 359 routes (0.0%) are `CLIENT_SIDE_ONLY`.** The prerendered HTML for these routes contains only meta tags and an empty `<div id="root"></div>`. Body content (review prose, comparison tables, FAQs, schema markup, internal links — everything below `<head>`) is rendered client-side after JS executes. **Google sees an empty page.**
...
| --- | ---: | ---: | ---: | ---: | --- |
| compare | 114 | 759 | 619 | 1967 | HEALTHY |
| discount | 71 | 835 | 774 | 889 | HEALTHY |
| review | 71 | 1100 | 730 | 1872 | HEALTHY |
| landing | 28 | 964 | 228 | 5770 | HEALTHY |
| niche | 21 | 765 | 488 | 2691 | HEALTHY |
| other | 18 | 1661 | 382 | 2038 | HEALTHY |
...
- **All 114 compare pages render as CLIENT_SIDE_ONLY** — Google sees identical 3.7KB meta-only HTML for each pair.
...
| /compare/hard-brit-lads-vs-prideflame | compare | 619 | 53.4 |  |
| /compare/bareback-that-hole-vs-brothercrush | compare | 639 | 54.3 |  |
...
| / | homepage | 651 | 84.0 |  |
| /compare/barebackcumpigs-vs-militarydick | compare | 662 | 55.9 |  |
