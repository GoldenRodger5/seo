...
const routes: RouteMeta[] = [
  ...
  { path: "/ask-ai", title: "Ask TwinkVault: Gay Porn Site Questions, Answered", description: `Ask anything about ${sites.length} reviewed gay membership sites: which fits you, what things really cost, which deal is worth it. Real answers, with links to the receipts.` },
  ...
  { path: "/gay-porn-awards-2026", title: `Gay Porn Awards ${YEAR}: TwinkVault Category Winners`, description: `The TwinkVault Gay Porn Awards ${YEAR}: 8 category winners chosen by transparent, reproducible criteria from ${sites.length} hand-scored membership sites.` },
  { path: "/gay-porn-pricing-index", title: `Gay Porn Pricing Index ${YEAR}: Real Costs | TwinkVault`, description: `How much does gay porn actually cost in ${YEAR}? Original pricing data from ${sites.length} membership sites: median prices, annual-vs-monthly gaps, and best value picks.` },
  ...
  { path: "/gay-porn-site-reviews", title: `Gay Porn Site Reviews — ${sites.length} Sites Scored | TwinkVault`, description: `Honest reviews of ${sites.length} gay porn sites in ${YEAR}: scored on content quality, value, updates, and mobile UX from paid memberships and hands-on research. Browse the catalog by niche or score.` },
  { path: "/gay-porn-sites-ranked", title: `Gay Porn Sites Ranked (${YEAR}) — Sortable Table | TwinkVault`, description: `All ${sites.length} gay porn sites in our database in one sortable table: content quality, value, updates, mobile, and price comparable at a glance. Refreshed monthly.` },
...
for (const site of sites) {
  // Editorial-only / unpriced sites have no affiliate deal and price_* === "n/a",
  // which rendered "$NaN" savings on the discount page. Skip them entirely —
  // a discount page only makes sense for a monetized site with a real price.
  if (site.editorial_status === "editorial-only" || site.price_annual === "n/a" || site.price_monthly === "n/a") continue;
