...
const routes: RouteMeta[] = [
  ...
  { path: "/ask-ai", title: "Ask TwinkVault: Gay Porn Site Questions, Answered", description: "Ask anything about 60+ reviewed gay membership sites: which fits you, what things really cost, which deal is worth it. Real answers, with links to the receipts." },
  ...
  { path: "/gay-porn-awards-2026", title: `Gay Porn Awards ${YEAR}: TwinkVault Category Winners`, description: `The TwinkVault Gay Porn Awards ${YEAR}: 8 category winners chosen by transparent, reproducible criteria from 60+ hand-scored membership sites.` },
