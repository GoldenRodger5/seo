...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // ─── Article 6 ─────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      h3("1. Helix Studios — Best Overall (Score 4.8/5)", "helix"),
      p("Helix Studios tops the board with the highest score in our entire database. 4,000+ exclusive scenes since 2002, cinematic production quality, an exclusive performer roster, and content available even on Amazon Prime Video. At $11.99/month annual it's the most expensive site in our top 10, but the production polish and roster exclusivity justify the premium for viewers who specifically value twink content at the cinematic end of the spectrum."),
      siteCta("helix-studios", "Top premium twink production since 2002 — 4,000+ exclusive scenes, cinematic quality."),
      h3("2. NakedSword — Biggest Library (Score 4.6/5)", "nakedsword"),
      ...
      h3("3. Men.com — Best Premium Network (Score 4.4/5)", "men"),
      ...
      h3("4. Sean Cody — Best Athletic Casting (Score 4.4/5)", "sean-cody"),
      ...
      h3("5. Twinks in Shorts — Best Amateur Twink (Score 4.4/5)", "twinks-in-shorts"),
      ...
      h3("6. PeterFever — Best Asian Gay (Score 4.3/5)", "peterfever"),
      ...
      h3("7. Athletic Twinks — Best Jock Twink (Score 4.3/5)", "athletic-twinks"),
      ...
      h3("8. Say Uncle — Best Taboo Network (Score 4.3/5)", "sayuncle"),
      ...
      h3("9. Twinkpop — Best Twink Network Channel (Score 4.2/5)", "twinkpop"),
      ...
      h3("10. GayAsianNetwork — Best Asian Value Bundle (Score 4.2/5)", "gayasiannetwork"),
      p("[GayAsianNetwork](/reviews/gayasiannetwork) at $9.95/month annual bundles multiple gay Asian sub-sites into a single membership — one login covering a broad mix of studio and amateur content across the niche. Solid HD across the network and a mobile-friendly player. Where PeterFever is the premium single-studio pick, GayAsianNetwork is the value play for viewers who want variety within the Asian niche for under $10/month."),
    ...
    related_sites: ["helix-studios", "nakedsword", "men", "sean-cody", "twinks-in-shorts", "peterfever", "athletic-twinks", "sayuncle", "twinkpop", "gayasiannetwork"],
