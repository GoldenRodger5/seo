...
export const COMPARISON_CONTENT: Record<string, ComparisonBody> = {
  "men-vs-sean-cody": {
    ...
    "comparison_categories": [
      ...
      },
      {
        ...
        "site_a_score": 5,
        "site_b_score": 8,
        "site_a_detail": "Men.com's base membership runs around $29.99 per month, but multiple verified member complaints document paywalls on top of that subscription — 1080p streaming and downloads reportedly require additional fees not disclosed upfront. The trial offer has drawn particular criticism for locking most content behind further charges after money is taken. Billing practices have generated consistent Trustpilot complaints through 2025, including accounts of unauthorised recurring charges and near-impossible cancellation paths.",
        "site_b_detail": "Sean Cody prices more cleanly: approximately $29.99 for a monthly membership, dropping to around $7.49/month on an annual commitment. Verified-member feedback skews notably more positive than Men.com's, with membership tiers that are genuinely tiered rather than used as upsell traps. Payment options include credit cards, PayPal, and Apple Pay, with discreet billing. The annual plan in particular represents strong value for consistent users."
      },
      {
  ...
  "men-vs-nakedsword": {
    ...
    "comparison_categories": [
      ...
      },
      {
        ...
        "site_a_score": 5,
        "site_b_score": 8,
        "site_a_detail": "Men.com sits around $29.99/month at standard pricing, and the billing practices have drawn consistent criticism — multiple Trustpilot reviewers report difficulty canceling, surprise premium tier charges, and paywalls blocking 1080p streaming on what's marketed as full-access membership. The content itself is solid, but the billing experience is a documented liability.",
        "site_b_detail": "NakedSword pricing runs roughly $9.99/month on an annual plan up to about $29.99/month billed month-to-month, with a quarterly option in between. Occasional trial and bundle promotions bring the entry cost down further. Given the sheer scene count you're unlocking, the per-scene cost math works heavily in the subscriber's favor on longer plans."
      },
      {
        "category": "Site Design & UX",
        "site_a_score": 6,
  ...
  "helix-studios-vs-sean-cody": {
    ...
    "comparison_categories": [
      ...
      },
      {
        ...
        "site_b_detail": "Standard monthly pricing of around $29.99 is on the higher end for a single-studio membership, though the annual plan brings it down to roughly $7.49/month. Aylo's cross-portfolio promotions can add value if you're interested in other network properties. The archive reduction, however, means you are paying a premium rate for a library that is materially smaller than it was five years ago."
      },
      {
        "category": "Site Design & UX",
        "site_a_score": 7,
  ...
  "dudesraw-vs-rawhole": {
    ...
    "intro": "Two bareback-focused sites. Same parent network. Completely different personalities. RawHole and DudesRaw both live under the zBuckz/WebMediaProz umbrella — a network that's been running gay membership sites since 2003, but they're not interchangeable. RawHole leans into sleek, produced bareback content with a broad cast and a steady publishing cadence. DudesRaw bets on something grittier: real-guy energy, a convincingly large model roster, and a deep library of videos with companion photo sets. If you're dropping $30 a month on bareback content, the choice between these two matters. We dug into both to figure out which one actually delivers.",
    "site_a_summary": "DudesRaw has quietly built one of the more substantive libraries in the zBuckz stable: a deep run of videos, companion photo sets, and a broad model roster. That's a meaningful headcount — enough that you're genuinely unlikely to exhaust familiar faces quickly. The site leans into authentic, unfiltered presentation: these aren't polished studio setups so much as encounters that feel lived-in. For viewers who find over-produced bareback content sterile, DudesRaw's rougher edges are a selling point. Regular updates keep the content calendar moving, and the photo-set accompaniment gives members more material per scene than most comparable sites offer.",
    ...
    "comparison_categories": [
      {
        ...
        "site_a_score": 8,
        "site_b_score": 7,
        "site_a_detail": "DudesRaw's library is substantial — a deep run of videos paired with companion photo sets and a broad model roster — which puts it ahead of most mid-tier bareback sites. The volume means new members have genuine depth to explore, and the photo sets add a layer of value that solo-video sites skip entirely.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "DudesRaw has the edge: a deeper library of videos plus companion photo sets and a broader model roster. RawHole's library count is less publicly documented, but based on its 2019 launch date and update activity, DudesRaw's library appears meaningfully larger. At equivalent pricing, DudesRaw delivers more content per dollar on current evidence."
      }
    ],
  ...
  "familydick-vs-sayuncle": {
    ...
    "comparison_categories": [
      ...
      },
      {
        ...
        "site_b_detail": "At approximately $29.95/month or ~$9.95/month billed annually, Say Uncle's per-scene cost is remarkably low given the catalog size. A 12-month membership works out to well under a dollar a day and includes unlimited downloads at that tier. The math strongly favors the annual plan — discount coupon codes regularly float around that drop the monthly equivalent further. The main friction point is that downloads are throttled on shorter-term plans."
      },
      {
        "category": "Site Design & UX",
        "site_a_score": 8,
  ...
  "southern-strokes-vs-twinks-in-shorts": {
    ...
    "comparison_categories": [
      {
        ...
        "site_b_detail": "Twinks in Shorts focuses on a specific massage-escalation format that keeps scenes feeling cohesive, but the overall catalog is on the smaller side. It's an actively ranked amateur site rather than a sprawling network, so the appeal is a curated, consistent library rather than sheer volume. What's there is quality — curated rather than voluminous."
      },
      {
        "category": "Pricing & Value",
        "site_a_score": 8,
        ...
        "site_b_detail": "Twinks in Shorts runs standard industry pricing through the MyGayCash network — around $29.95/month, dropping to roughly $9.95/month on the annual plan, which is strong value for the niche. That annual rate makes it an easy, low-cost addition alongside a broader membership, and the focused catalog means you know exactly what you're paying for."
      },
      {
        "category": "Site Design & UX",
        "site_a_score": 6,
      ...
      },
      {
        ...
        "site_b_detail": "Twinks in Shorts is an active site rather than a static archive, though as a focused single-niche operation it won't match a mega-network's cadence. New scenes arrive at a measured pace, and the deep-enough catalog means there's plenty to work through between drops. For a niche amateur site at this price, the update rhythm is reasonable rather than remarkable."
      },
      {
        "category": "Niche Focus",
        "site_a_score": 8,
    ...
    "verdict": "These two sites appeal to overlapping but distinct corners of the twink-loving audience. Southern Strokes is the stronger all-around membership in 2026 — it has the catalog depth, the proven update history through at least 2025, and a clearly defined brand identity that's been consistent for over fifteen years. Recurring performers across multiple seasons give it a character-driven quality most niche sites can't match, and the value proposition of accessing that archive at standard niche pricing is genuinely solid. Twinks in Shorts, on the other hand, wins decisively on specificity: if the massage-escalation format is your thing, no other site does it with the same amateur authenticity, and that focused execution earns it serious points. It's an active, well-priced site — around $9.95/month on the annual plan — so the real question isn't whether it's alive but whether one narrow niche is enough to hold your interest long-term. If we're being direct: both are legitimate picks, and at their annual rates you could comfortably run them side by side. Expecting daily updates from either single-niche site would be setting yourself up for disappointment, but each delivers reliably within its lane.",
    "who_should_choose_a": "Choose Southern Strokes if you want a deep back-catalog with recurring performers you can follow across scenes and a consistent All-American twink aesthetic at a fair price.",
    ...
    "faq": [
      {
        ...
        "a": "Yes — Twinks in Shorts is an active, currently-ranked amateur site, not a static archive. It sits among our higher-rated twink picks, with authentic unscripted scenes and value-friendly pricing (around $9.95/month on the annual plan through MyGayCash). As a focused single-niche site it won't match a mega-network's update cadence, but new content lands at a steady pace and the existing library gives you plenty to work through. Go in expecting a curated niche experience rather than a daily-drip feed."
      },
      {
  ...
  "athletic-twinks-vs-southern-strokes": {
    ...
    "comparison_categories": [
      ...
      },
      {
        ...
        "site_b_detail": "Southern Strokes prices are consistently competitive, typically around $29.95 per month with meaningful discounts on longer plans — roughly $9.95/month on the annual option. The volume of content relative to the price is one of the better ratios in the indie twink space. Occasional sale pricing and recurring promotional rates have been reported by members, and the sheer size of the back-catalogue means new subscribers get immediate density of content for their first payment."
      },
      {
        "category": "Site Design & UX",
        "site_a_score": 7,
