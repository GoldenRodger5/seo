...
export const siteImagery: Record<string, SiteImagery> = {
  ...
  "helix-studios": { hero_wide: true, hero_image_url: "/site-banners/helix-studios-hero.jpg", thumbnail_url: "/site-banners/helix-studios-card.jpg", banner_alt: "Helix Studios — twink gay porn site banner" },
  ...
  "daddy-on-twink": { hero_image_url: "/site-banners/daddy-on-twink-hero.jpg", thumbnail_url: "/site-banners/daddy-on-twink-card.jpg", banner_alt: "Daddy on Twink — daddy gay porn site banner" },
  "touch-that-boy": { hero_image_url: "/site-banners/touch-that-boy-hero.jpg", thumbnail_url: "/site-banners/touch-that-boy-card.jpg", banner_alt: "Touch That Boy — twink gay porn site banner" },
  ...
  "peterfever": { hero_wide: true, hero_image_url: "/site-banners/peterfever-hero.jpg", thumbnail_url: "/site-banners/peterfever-card.jpg", banner_alt: "PeterFever — asian gay porn site banner" },
  "gayasiannetwork": { hero_image_url: "/site-banners/gay-asian-network-hero.jpg", thumbnail_url: "/site-banners/gay-asian-network-card.jpg", banner_alt: "GayAsianNetwork — asian gay porn site banner" },
  "alternadudes": { hero_wide: true, hero_image_url: "/site-banners/alternadudes-hero.jpg", thumbnail_url: "/site-banners/alternadudes-card.jpg", banner_alt: "AlternaDudes — amateur gay porn site banner" },
  "dirtyboyvideo": { hero_wide: true, hero_image_url: "/site-banners/dirty-boy-video-hero.jpg", thumbnail_url: "/site-banners/dirty-boy-video-card.jpg", banner_alt: "DirtyBoyVideo — amateur gay porn site banner" },
  ...
  // hero grabbed from the site's straight homepage (female performers) — wrong for a gay review; placeholder until brand-correct art is sourced
  "sexjapantv": { hero_image_url: null, thumbnail_url: null, banner_alt: "SexJapanTV — japanese gay porn site banner" },
  ...
  "wuboyz": { hero_image_url: "/site-banners/wuboyz-hero.jpg", thumbnail_url: "/site-banners/wuboyz-card.jpg", banner_alt: "WuBoyz — asian gay porn site banner" },
  "barebackrtxxx": { hero_wide: true, hero_image_url: "/site-banners/barebackrtxxx-hero.jpg", thumbnail_url: "/site-banners/barebackrtxxx-card.jpg", banner_alt: "Bareback RT XXX — bareback gay porn site banner" },
  "cumpigmen": { hero_wide: true, hero_image_url: "/site-banners/cumpigmen-hero.jpg", thumbnail_url: "/site-banners/cumpigmen-card.jpg", banner_alt: "Cum Pig Men — bareback gay porn site banner" },
  "realmenfuck": { hero_wide: true, hero_image_url: "/site-banners/real-men-fuck-hero.jpg", thumbnail_url: "/site-banners/real-men-fuck-card.jpg", banner_alt: "Real Men Fuck — amateur gay porn site banner" },
  "swinginballs": { hero_wide: true, hero_image_url: "/site-banners/swingin-balls-hero.jpg", thumbnail_url: "/site-banners/swingin-balls-card.jpg", banner_alt: "Swingin Balls — amateur gay porn site banner" },
  ...
  "dadcreep": { hero_wide: true, hero_image_url: "/site-banners/dad-creep-hero.jpg", thumbnail_url: "/site-banners/dad-creep-card.jpg", banner_alt: "Dad Creep — daddy gay porn site banner" },
  ...
  "sayuncle": { hero_wide: true, hero_image_url: "/site-banners/say-uncle-hero.jpg", thumbnail_url: "/site-banners/sayuncle-card.jpg", banner_alt: "Say Uncle — daddy gay porn site banner" },
  ...
  "militarydick": { hero_wide: true, hero_image_url: "/site-banners/military-dick-hero.jpg", thumbnail_url: "/site-banners/military-dick-card.jpg", banner_alt: "Military Dick — military gay porn site banner" },
  ...
  "bullyhim": { hero_wide: true, hero_image_url: "/site-banners/bully-him-hero.jpg", thumbnail_url: "/site-banners/bully-him-card.jpg", banner_alt: "Bully Him — twink gay porn site banner" },
  ...
  "maleaccess": { hero_wide: true, hero_image_url: "/site-banners/maleaccess-hero.jpg", thumbnail_url: "/site-banners/maleaccess-card.jpg", banner_alt: "MaleAccess — gay porn site banner" },
  "men": { hero_wide: true, hero_image_url: "/site-banners/men-hero.jpg", thumbnail_url: "/site-banners/men-card.jpg", banner_alt: "Men.com — gay porn site banner" },
  "next-door-studios": { hero_wide: true, hero_image_url: "/site-banners/next-door-studios-hero.jpg", thumbnail_url: "/site-banners/next-door-studios-card.jpg", banner_alt: "Next Door Studios — gay porn site banner" },
  "noirmale": { hero_wide: true, hero_image_url: "/site-banners/noirmale-hero.jpg", thumbnail_url: "/site-banners/noirmale-card.jpg", banner_alt: "Noir Male — gay porn site banner" },
  ...
  "sean-cody": { hero_wide: true, hero_image_url: "/site-banners/sean-cody-hero.jpg", thumbnail_url: "/site-banners/sean-cody-card.jpg", banner_alt: "Sean Cody — gay porn site banner" },
  // hero grabbed from SpiceVids' straight homepage (female performers) — wrong for the gay access layer; placeholder until brand-correct art is sourced
  "spicevidsgay": { hero_image_url: null, thumbnail_url: null, banner_alt: "SpiceVids Gay — gay porn site banner" },
  ...
  "raging-stallion": { hero_wide: true, hero_image_url: "/site-banners/raging-stallion-hero.jpg", thumbnail_url: "/site-banners/raging-stallion-card.jpg", banner_alt: "Raging Stallion — gay porn site banner" },
  "hot-house": { hero_wide: true, hero_image_url: "/site-banners/hot-house-hero.jpg", thumbnail_url: "/site-banners/hot-house-card.jpg", banner_alt: "Hot House — gay porn site banner" },
  ...
  "icon-male": { hero_wide: true, hero_image_url: "/site-banners/icon-male-hero.jpg", thumbnail_url: "/site-banners/icon-male-card.jpg", banner_alt: "Icon Male — gay porn site banner" },
  "twinkpop": { hero_wide: true, hero_image_url: "/site-banners/twinkpop-hero.jpg", thumbnail_url: "/site-banners/twinkpop-card.jpg", banner_alt: "TwinkPop — gay porn site banner" },
  "bigstr": { hero_wide: true, hero_image_url: "/site-banners/bigstr-hero.jpg", thumbnail_url: "/site-banners/bigstr-card.jpg", banner_alt: "BigStr — gay porn site banner" },
  "guy-selector": { hero_wide: true, hero_image_url: "/site-banners/guy-selector-hero.jpg", thumbnail_url: "/site-banners/guy-selector-card.jpg", banner_alt: "Guy Selector — gay porn site banner" },
};
...
const STRIP_HERO_SLUGS = new Set([
  ...
  "trailertrashboys", "blackgodz", "bottomgames", "brothercrush", "youngperps",
]);
