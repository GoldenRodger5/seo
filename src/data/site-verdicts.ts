/**
 * Editorial verdicts shown on each review page above the main CTA.
 * Format: 1–2 sentences. First sentence states who it's for; the second
 * (when present) states who should skip it or what the catch is.
 *
 * Sourced inline from each site's pros/cons/scores rather than a separate
 * data layer so updates ship with the rest of the site copy.
 */
export const siteVerdicts: Record<string, string> = {
  ...
  "daddy-on-twink":
    "Cleanly executed intergenerational scenes with genuine chemistry between performers. Skip it if you specifically want pure twink-on-twink content.",
  "touch-that-boy":
    "An intimate, sensual angle that most twink sites don't bother with. Skip it if you want intensity over connection.",
  "breed-me-raw":
    "Raw, energetic scenes with passionate performers and no overproduced gloss. Skip it if you want condom-only content.",
  "bareback-that-hole":
  ...
  "dirtyboyvideo":
    "Authentic, no-frills content at one of the lower annual prices in the zBuckz lineup. Skip it if you want studio polish over real-guy energy.",
  "trailertrashboys":
  ...
  "japanboyz":
    "The leading English-language gateway to authentic Japanese gay content. Skip it if you want Western performers or English dialogue.",
  "sexjapantv":
  ...
  "swinginballs":
    "Fun, lighter-toned gay content with solid HD streaming on the zBuckz network. Skip it if you want intensity over playfulness.",
  "squirtstudios":
    "Niche-fetish content with a release-focused angle. Skip it if you want broader scene variety.",
  "aussiesdoit":
    "Australian performers and outdoor settings give this a genuinely different accent in the niche. Skip it if it's the casting, not the location, that matters to you.",
  "twinktrade":
    "Strong amateur-feeling bareback twink content and one of ChargedCash's most popular sites. Skip it if you want studio-cinematic production.",
  "dadcreep":
    "High-production daddy-twink taboo with consistent update cadence. Skip it if taboo scenarios aren't your thing.",
  "brothercrush":
  ...
  "boysatcamp":
    "Outdoor, summer-camp-themed twink content with an amateur energy you don't get from studio sites. Skip it if you want urban or interior settings.",
  "missionaryboys":
    "The premium pick for religious-roleplay taboo content with notably high production values. Skip it if roleplay scenarios aren't your draw.",
  "militarydick":
  ...
  "bullyhim":
    "Power-dynamics twink content that's intentionally intense and edgy. Skip it if you prefer softer, more egalitarian scenes.",
  "youngperps":
    "Cop-and-authority roleplay with twink performers, solid production values, and tight scenarios. Skip it if you want non-roleplay content.",
  "barebackcumpigs":
