...
const BestTwinkPorn = () => (
  <SeoLandingPage
    ...
    intro="We've reviewed and scored every twink-focused site in this list. This page ranks them by content quality first (production polish, performer chemistry, scene depth) rather than by value or breadth — different angle from our value-focused rankings."
    sites={filtered}
